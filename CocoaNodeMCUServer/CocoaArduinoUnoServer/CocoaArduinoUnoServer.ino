...
const int led1 = 2; // Porta   D0
const int led2 = 3;  // Porta   D3
const int led3 = 4; // Porta   D4
const int led4 = 5;  // Porta   D8
const int led5 = 7; // Porta   SD2
const int led6 = 8; // Porta   SD3
